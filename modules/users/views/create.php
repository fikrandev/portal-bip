    ...
    <div class="bg-white rounded-2xl border border-primary-100/60 shadow-sm p-6 sm:p-8">
        <form action="<?= url('users/store') ?>" method="POST" id="form-create-user">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-semibold text-primary-800 mb-1.5">Konfirmasi Password <span class="text-rose-500">*</span></label>
            ...
            <div class="mb-5">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <label class="inline-flex items-center gap-2 px-3 py-2 rounded-full border border-primary-200 hover:border-primary-300 has-[:checked]:bg-primary-50 has-[:checked]:border-primary-400 cursor-pointer transition-all text-sm">
                        <input type="checkbox" name="roles[]" value="<?= $role['id'] ?>" class="rounded border-primary-300 text-primary-500 focus:ring-0 focus:ring-transparent ">
