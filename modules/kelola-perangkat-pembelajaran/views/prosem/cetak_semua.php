...
<head>
    ...
    <title>Cetak Semua Program Semester - <?= e($group['judul']) ?></title>
    ...
    <div class="no-print fixed top-4 right-4 z-50 flex items-center gap-3">
        <div class="bg-white/95 backdrop-blur shadow-xl border border-slate-200 rounded-2xl p-2 flex items-center gap-2">
            <span class="text-xs font-bold text-slate-700 px-2">
                Total: <?= count($items) ?> Dokumen Prosem
            </span>
    ...
    <div class="screen-wrapper">
        <?php if (empty($items)): ?>
            <div class="page-sheet text-center py-12">
                <p class="text-base font-bold text-slate-500">Tidak ada dokumen Program Semester di dalam wadah ini untuk dicetak.</p>
            </div>
        <?php else: ?>
